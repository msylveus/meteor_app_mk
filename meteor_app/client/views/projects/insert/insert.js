...
Template.ProjectsInsert.onCreated(function() {
	
});

Template.ProjectsInsert.onDestroyed(function() {
	
});

Template.ProjectsInsert.onRendered(function() {
...
Template.ProjectsInsertForm.onCreated(function() {
	console.log("Temple created code");
});

Template.ProjectsInsertForm.onDestroyed(function() {
	
});

Template.ProjectsInsertForm.onRendered(function() {
	...
	"submit": function(e, t) {
		...
		validateForm(
			...
			function(values) {
				...
				Meteor.call("projectsInsert", values, function(e, r) { if(e) errorAction(e); else submitAction(r); });
			}
		);
